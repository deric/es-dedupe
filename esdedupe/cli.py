...
class ArgumentParser(_Base):
    ...
    def parse_args(self, args):
        ...
        self.add_argument(
            "-t", "--doc_type", dest="doc_type", default=None, help="ES document type"
        )
        self.add_argument(
            "-T", "--timestamp", dest="timestamp", default=None, help="Timestamp field"
        )
        self.add_argument(
            "-F",
            "--since",
        ...
        self.add_argument(
            "--check_log", dest="check", help="Verify that documents has been deleted"
        )
        self.add_argument(
            "-n",
            "--noop",
        ...
        self.add_argument("--user", dest="user", default=None, help="HTTP auth user")
        self.add_argument(
            "--password", dest="password", default=None, help="HTTP auth password"
        )
        self.add_argument(
            "--ssl", action="store_true", dest="ssl", default=False, help="Use SSL"
        )
        self.add_argument(
            "-k",
            "--insecure",
        ...
        self.add_argument("--syslog-device", default="/dev/log", help="Syslog device")
        self.add_argument("--syslog-facility", default="local0", help="Syslog facility")
        self.add_argument(
            "--mem-report",
            dest="mem_report",
            default=1000000,
