...
def dedupe():
    ...
    # fill with documents
    for i in range(5):
        es.create(index=INDEX, id=random_string(8), body={"timestamp": "2021-01-01T01:01:00.000Z", "name": "foo"})
    for i in range(5):
        es.create(index=INDEX, id=random_string(8), body={"timestamp": "2021-01-01T01:05:00.000Z", "name": "bar"})
    for i in range(5):
        es.create(index=INDEX, id=random_string(8), body={"timestamp": "2021-01-01T01:12:00.000Z", "name": "baz"})
    for i in range(5):
        es.create(index=INDEX, id=random_string(8), body={"timestamp": "2021-01-01T01:13:00.000Z", "name": "boo"})
